...
Source0  : https://files.pythonhosted.org/packages/50/4f/3305c8d78dbb776017aad02f4ec8eb49cffed6ed80f5773259b9e16844c6/diff_cover-9.1.0.tar.gz
...
%prep
%setup -q -n diff_cover-9.1.0
cd %{_builddir}/diff_cover-9.1.0
pushd ..
cp -a diff_cover-9.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719416319
