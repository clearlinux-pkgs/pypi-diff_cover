...
Source0  : https://files.pythonhosted.org/packages/ec/7e/368f94d646c67a6b1c4807c7c50e6e5c076748f71d16752cd20ba16070a5/diff_cover-8.0.3.tar.gz
...
%prep
%setup -q -n diff_cover-8.0.3
cd %{_builddir}/diff_cover-8.0.3
pushd ..
cp -a diff_cover-8.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705865185
