...
Source0  : https://files.pythonhosted.org/packages/53/54/de08694e2335af338416ad968afe8c3115c56d4825dc4402f43dcf27218a/diff_cover-9.1.1.tar.gz
...
%prep
%setup -q -n diff_cover-9.1.1
cd %{_builddir}/diff_cover-9.1.1
pushd ..
cp -a diff_cover-9.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721316758
