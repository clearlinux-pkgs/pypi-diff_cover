...
Source0  : https://files.pythonhosted.org/packages/3f/a8/20e11859ee291893ef9711ca868d277b66cdf886278e73abdb72b172cc5f/diff_cover-9.2.4.tar.gz
...
%prep
%setup -q -n diff_cover-9.2.4
cd %{_builddir}/diff_cover-9.2.4
pushd ..
cp -a diff_cover-9.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742454894
