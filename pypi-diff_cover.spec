...
Source0  : https://files.pythonhosted.org/packages/80/fe/520fcd6ee8075dab12cb78f3b18eb1968b720197b88b0018df61a9b59445/diff_cover-8.0.0.tar.gz
...
%prep
%setup -q -n diff_cover-8.0.0
cd %{_builddir}/diff_cover-8.0.0
pushd ..
cp -a diff_cover-8.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697470423
