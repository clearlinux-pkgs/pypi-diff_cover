...
Source0  : https://files.pythonhosted.org/packages/dd/23/d26ca0d7401c362fd1d760947c8436790fd4e76fcf110323f1a2e35ab981/diff_cover-9.0.0.tar.gz
...
%prep
%setup -q -n diff_cover-9.0.0
cd %{_builddir}/diff_cover-9.0.0
pushd ..
cp -a diff_cover-9.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713191756
