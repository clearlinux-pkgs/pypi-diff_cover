...
Source0  : https://files.pythonhosted.org/packages/36/b0/f3ccf97926f6e5cc76d5ece42f3c685d75673d1886fcec62886b8b00c51a/diff_cover-9.2.1.tar.gz
...
%prep
%setup -q -n diff_cover-9.2.1
cd %{_builddir}/diff_cover-9.2.1
pushd ..
cp -a diff_cover-9.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735095169
