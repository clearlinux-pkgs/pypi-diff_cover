...
Source0  : https://files.pythonhosted.org/packages/a6/f9/cc775fdcdce3407b5ef46ae084950514c0429b0e2407b6d5a0990bf52505/diff_cover-9.3.2.tar.gz
...
%prep
%setup -q -n diff_cover-9.3.2
cd %{_builddir}/diff_cover-9.3.2
pushd ..
cp -a diff_cover-9.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748877407
