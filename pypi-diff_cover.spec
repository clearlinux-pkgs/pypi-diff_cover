...
Source0  : https://files.pythonhosted.org/packages/44/3a/e49ccba052a4dda264fbad4f467739ecc63498f7223bfc03d4bfac23ea95/diff_cover-9.2.0.tar.gz
...
%prep
%setup -q -n diff_cover-9.2.0
cd %{_builddir}/diff_cover-9.2.0
pushd ..
cp -a diff_cover-9.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725760343
