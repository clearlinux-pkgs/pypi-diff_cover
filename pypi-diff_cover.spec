...
Source0  : https://files.pythonhosted.org/packages/27/03/9b78acb6ccd661a7679776885eda642ad33061697f054516324c0526c906/diff_cover-9.2.3.tar.gz
...
%prep
%setup -q -n diff_cover-9.2.3
cd %{_builddir}/diff_cover-9.2.3
pushd ..
cp -a diff_cover-9.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739977680
